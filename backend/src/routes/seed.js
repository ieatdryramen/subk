...
async function demoSeedHandler(req, res) {
  ...
  try {
    ...
    const primes = [
      ...
      ['ManTech International', '61788', 'MANTECHUEI001', 'https://mantech.com', '541512,541519,561210', 'ISO 27001, NIST 800-171, CMMI Level 3', 2800000000, 156, 'DOD, Intelligence, Federal Civilian', 'Large', 79, 'Mid-tier prime with strong cyber operations focus, looking for DevSecOps subcontractors', 'meeting_set', 'Robert Taylor', 'r.taylor@mantech.com', 'VP Business Development'],
      ['Peraton', '5SZE0', 'PERATONUEI001', 'https://peraton.com', '541512,541519,517312', 'FedRAMP, ISO 27001, CMMI Level 5', 6800000000, 234, 'Intelligence, DOD, Civilian', 'Large', 85, 'Massive IC footprint, aggressively expanding SB partnerships for zero trust and FedRAMP work', 'teaming_agreement', 'Amanda White', 'a.white@peraton.com', 'Teaming Coordinator'],
    ];
