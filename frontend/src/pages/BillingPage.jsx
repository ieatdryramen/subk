...
const s = {
  ...
  planCard: (featured, current) => ({ background: current ? 'rgba(8,165,191,0.05)' : '#FFFFFF', border: current ? '2px solid var(--accent)' : featured ? '1px solid rgba(8,165,191,0.3)' : '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '1.5rem', position: 'relative' }),
