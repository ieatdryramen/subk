...
const s = {
  ...
  planCard: (featured, current) => ({ background: current ? 'rgba(108,99,255,0.05)' : 'var(--bg2)', border: current ? '2px solid var(--accent)' : featured ? '1px solid rgba(108,99,255,0.3)' : '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '1.5rem', position: 'relative' }),
