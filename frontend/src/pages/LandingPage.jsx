...
const s = {
  ...
  signupBtn: { padding: '8px 20px', background: '#1e6fff', border: 'none', color: '#fff', borderRadius: 8, fontSize: 13, fontWeight: 500, cursor: 'pointer' },
  hero: { textAlign: 'center', padding: '6rem 2rem 4rem', maxWidth: 800, margin: '0 auto' },
  eyebrow: { display: 'inline-block', padding: '4px 14px', background: 'rgba(30,111,255,0.15)', border: '1px solid rgba(30,111,255,0.3)', borderRadius: 20, fontSize: 12, fontWeight: 500, color: '#5b9fff', marginBottom: '1.5rem', letterSpacing: '0.5px', textTransform: 'uppercase' },
  h1: { fontSize: 56, fontWeight: 700, fontFamily: 'Syne, sans-serif', lineHeight: 1.1, marginBottom: '1.5rem', letterSpacing: '-1px' },
  h1Accent: { color: '#1e6fff' },
  ...
  ctaPrimary: { padding: '14px 32px', background: '#1e6fff', border: 'none', color: '#fff', borderRadius: 10, fontSize: 15, fontWeight: 500, cursor: 'pointer' },
  ...
  planCard: (featured) => ({ background: featured ? 'rgba(30,111,255,0.08)' : '#1A202C', border: featured ? '1px solid rgba(30,111,255,0.4)' : '1px solid rgba(255,255,255,0.06)', borderRadius: 14, padding: '2rem', position: 'relative' }),
  planBadge: { position: 'absolute', top: -12, left: '50%', transform: 'translateX(-50%)', background: '#1e6fff', color: '#fff', fontSize: 11, fontWeight: 600, padding: '4px 14px', borderRadius: 20, whiteSpace: 'nowrap', letterSpacing: '0.5px', textTransform: 'uppercase' },
  ...
  planFeatureDot: { position: 'absolute', left: 0, color: '#1e6fff' },
  planBtn: (featured) => ({ width: '100%', padding: '11px', background: featured ? '#1e6fff' : 'transparent', border: featured ? 'none' : '1px solid rgba(255,255,255,0.15)', color: featured ? '#fff' : '#f0f0f5', borderRadius: 8, fontSize: 14, fontWeight: 500, cursor: 'pointer', marginTop: '1.5rem' }),
  ...
  stepNum: { width: 40, height: 40, borderRadius: '50%', background: 'rgba(30,111,255,0.15)', border: '1px solid rgba(30,111,255,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem', fontSize: 15, fontWeight: 600, color: '#5b9fff' },
