...
const s = {
  page: { minHeight: '100vh', background: '#0a0a0f', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', fontFamily: "'Inter', sans-serif" },
  card: { width: '100%', maxWidth: 420, background: '#111118', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: '2.5rem', boxShadow: '0 24px 48px rgba(0,0,0,0.4)' },
  logo: { fontFamily: 'Syne, sans-serif', fontSize: 22, fontWeight: 700, color: '#f0f0f5', marginBottom: 8 },
  tagline: { fontSize: 13, color: '#6060788', marginBottom: '2rem' },
  heading: { fontSize: 22, fontWeight: 600, fontFamily: 'Syne, sans-serif', marginBottom: 6, color: '#f0f0f5' },
  sub: { fontSize: 13, color: '#9090a8', marginBottom: '1.75rem' },
  field: { marginBottom: 14 },
  label: { display: 'block', fontSize: 12, fontWeight: 500, color: '#9090a8', marginBottom: 5 },
  input: { width: '100%', padding: '10px 12px', background: '#0d0d14', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: '#f0f0f5', fontSize: 14, outline: 'none' },
  btn: { width: '100%', padding: '11px', background: '#6c63ff', border: 'none', color: '#fff', borderRadius: 9, fontSize: 14, fontWeight: 500, cursor: 'pointer', marginTop: 6 },
  ...
  switch: { textAlign: 'center', marginTop: '1.5rem', fontSize: 13, color: '#9090a8' },
  switchLink: { color: '#8b84ff', cursor: 'pointer', fontWeight: 500 },
  ...
  dividerText: { fontSize: 11, color: '#505068', whiteSpace: 'nowrap' },
  inviteNote: { background: 'rgba(108,99,255,0.1)', border: '1px solid rgba(108,99,255,0.2)', borderRadius: 8, padding: '10px 12px', fontSize: 12, color: '#8b84ff', marginBottom: 14 },
};
      ...
      <div style={s.card}>
        ...
        <form onSubmit={submit}>
          ...
          {mode === 'register' && !inviteCode && (
            <div style={s.field}>
              <label style={s.label}>Invite code <span style={{ color: '#505068' }}>(optional)</span></label>
        ...
        {mode === 'register' && (
          <div style={{ fontSize: 11, color: '#505068', textAlign: 'center', marginTop: 10, lineHeight: 1.5 }}>
